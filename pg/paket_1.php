			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						...
						<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(-433px, 0px, 0px);"><li data-thumb="images/s3.jpg" class="clone" aria-hidden="true" style="width: 433px; float: left; display: block;">
								   <div class="thumb-image"> <img src="images/s3.jpg" data-imagezoom="true" class="img-responsive" alt="" draggable="false"> </div>
								</li>
								<li data-thumb="images/s1.jpg" class="flex-active-slide" style="width: 433px; float: left; display: block;">
									<div class="thumb-image detail_images"> <img src="images/s1.jpg" data-imagezoom="true" class="img-responsive" alt="" draggable="false"> </div>
								</li>
								<li data-thumb="images/s2.jpg" class="" style="width: 433px; float: left; display: block;">
									 <div class="thumb-image"> <img src="images/s2.jpg" data-imagezoom="true" class="img-responsive" alt="" draggable="false"> </div>
								</li>
								<li data-thumb="images/s3.jpg" class="" style="width: 433px; float: left; display: block;">
								   <div class="thumb-image"> <img src="images/s3.jpg" data-imagezoom="true" class="img-responsive" alt="" draggable="false"> </div>
								</li> 
							<li data-thumb="images/s1.jpg" class="clone" aria-hidden="true" style="width: 433px; float: left; display: block;">
									<div class="thumb-image detail_images"> <img src="images/s1.jpg" data-imagezoom="true" class="img-responsive" alt="" draggable="false"> </div>
								</li></ul></div><ol class="flex-control-nav flex-control-thumbs"><li><img src="images/s1.jpg" class="flex-active" draggable="false"></li><li><img src="images/s2.jpg" draggable="false" class=""></li><li><img src="images/s3.jpg" draggable="false" class=""></li></ol><ul class="flex-direction-nav"><li class="flex-nav-prev"><a class="flex-prev" href="#">Previous</a></li><li class="flex-nav-next"><a class="flex-next" href="#">Next</a></li></ul></div>
					</div>
